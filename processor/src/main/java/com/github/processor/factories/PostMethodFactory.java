...
public class PostMethodFactory implements RESTMethodsFactory {

    @Override
    public MethodSpec method(Element method, Arthas arthas) {
        AnnotationRESTMethodsEmulator annotation = new AnnotationRESTMethodsEmulator(method, AnnotationRESTMethodsEmulator.POST_MAPPING);
