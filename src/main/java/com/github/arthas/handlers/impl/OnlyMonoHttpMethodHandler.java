...
public final class OnlyMonoHttpMethodHandler implements IHttpMethod {

    private final StaticMetaInfo methodMetaInfo;

    public OnlyMonoHttpMethodHandler(StaticMetaInfo methodMetaInfo) {
    ...
    public Object method(WebClient webClient, String baseUri, Object[] arguments, Parameter[] params) {
        ...
        return ProxyMethodsDeclarations.onlyMono(
                webClient,
