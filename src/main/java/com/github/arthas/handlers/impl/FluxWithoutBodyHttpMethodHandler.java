...
public final class FluxWithoutBodyHttpMethodHandler implements IHttpMethod {

    private final StaticMetaInfo methodMetaInfo;

    public FluxWithoutBodyHttpMethodHandler(StaticMetaInfo methodMetaInfo) {
    ...
    public Object method(WebClient webClient, String baseUri, Object[] arguments, Parameter[] params) {
        ...
        return ProxyMethodsDeclarations.fluxWithoutBody(
                webClient,
                uri(
                        baseUri,
